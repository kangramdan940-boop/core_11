    ...
    Route::middleware(['auth', 'admin_or_agen'])->group(function () {
        ...
        */
        Route::prefix('master')->name('master.')->group(function () {
            ...
            Route::post('ready-stocks/activate-all', [MasterGoldReadyStockController::class, 'activateAll'])
                ->name('ready-stocks.activate-all');
            Route::post('ready-stocks/activate-all', [MasterGoldReadyStockController::class, 'activateAll'])
                ->name('ready-stocks.activate-all');
        ...
        */
        Route::prefix('trans')->name('trans.')->group(function () {
            ...
            Route::prefix('po')->name('po.')->group(function () {
                ...
                Route::get('/export', [TransPoController::class, 'export'])->name('export');
