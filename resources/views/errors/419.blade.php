    ...
    <section class="boarding-sec">
        <div class="tf-container">
            <div class="content-boarding text-center" style="padding-top:80px; padding-bottom:40px;">
                <h1 class="title">Halaman ini sudah expired</h1>
                <p class="desc">Klik tombol di bawah untuk kembali melanjutkan.</p>
            </div>
        </div>
        <div class="fixed-button group-btn-boarding">
            <div class="row g-2">
                <div class="col-12 text-center">
                    <a href="{{ url('/admin/login') }}" class="tf-btn primary d-block w-100 mb-0">Login</a>
                </div>
            </div>
        </div>
    </section>
