...
<div class="container py-4">
    <div class="mb-3 d-flex gap-2">
        <a href="{{ route('customer.cicilan.index') }}" class="btn btn-secondary btn-sm">← Kembali</a>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <hr>
            <h6 class="mb-2">Form Kontrak Cicilan</h6>
            <form action="{{ route('customer.cicilan.store') }}" method="POST" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="shipping_phone" class="form-control" value="{{ $customer->phone_wa ?? '' }}">
                </div>
                <div class="col-md-12">
                    <label class="form-label">Alamat</label>
                    <textarea name="shipping_address" class="form-control" rows="2">{{ $customer->address_line ?? '' }}</textarea>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Kota</label>
                    <input type="text" name="shipping_city" class="form-control" value="{{ $customer->kota ?? '' }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Provinsi</label>
                    <input type="text" name="shipping_province" class="form-control" value="{{ $customer->provinsi ?? '' }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Kode Pos</label>
                    <input type="text" name="shipping_postal_code" class="form-control" value="{{ $customer->kode_pos ?? '' }}">
                </div>
                <div class="col-12">
