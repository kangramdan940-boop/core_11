                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="category-job">
                                <a href="{{ route('customer.buyback.index') }}" class="box-img">
                                    <span style="display:flex;align-items:center;justify-content:center;width:46px;height:46px;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#1a7f37" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <a class="title" href="{{ route('customer.buyback.index') }}">Ajukan Buyback</a>
                            </div>
                        </div>
                        @foreach(($menus ?? []) as $m)
                            <div class="swiper-slide">
