...
<body>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      var btn = document.getElementById('copyRekBtnReadyAccount');
      var el = document.getElementById('rekTujuanReady');
      var st = document.getElementById('copyStatusReadyAccount');
      ...
      function copy(){
        ...
        if (navigator.clipboard && navigator.clipboard.writeText) {
          navigator.clipboard.writeText(txt).then(showSuccess).catch(function(err){
            ...
            <div class="row align-items-center g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-secondary py-0 px-2" id="copyRekBtnReadyAccount" title="Salin">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M16 1H4c-1.1 0-2 .9-2 2v12h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/></svg>
                        </button>
                        <span id="copyStatusReadyAccount" class="text-success small fw-bold" style="display:none;">Tersalin!</span>
                    </div>
                    <div>Atas Nama : {{ optional($ready->agen)->name ?? '-' }}</div>
                </div>
            </div>
        </div>
    @endif
