            ...
            <form method="post" action="{{ route('customer.register.submit') }}">
                    ...
                    <fieldset class="input-icon mt-12">
                        <span class="icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M5.9666 12.1333C3.94993 13.4833 3.94993 15.6833 5.9666 17.0249C8.25827 18.5583 12.0166 18.5583 14.3083 17.0249C16.3249 15.6749 16.3249 13.4749 14.3083 12.1333C12.0249 10.6083 8.2666 10.6083 5.9666 12.1333Z" stroke="#121927" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                                </g>
                            </svg>                               
                        </span>
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Type your full name" class="form-control">
                        @error('name')<div class="text-danger small mt-2">{{ $message }}</div>@enderror
                    </fieldset>
                </div>
                    <div class="mt-32 form-field form-2">
                    <h6 class="label">No Telepone (Whatsapp)</h6>
                    <fieldset class="input-icon mt-12">
                        <span class="icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.5">
                ...
                <div class="mt-20 form-field form-2">
                    ...
                    <fieldset class="input-icon mt-12">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="Type your email" class="form-control">
                ...
                <div class="mt-20 form-field form-2">
                    ...
                    <fieldset class="mt-16 input-icon">
                        <div class="box-view-hide">
                            ...
                            <input type="password" name="password" placeholder="Type your password" class="form-control password-field" required>
                ...
                <div class="mt-20 form-field form-2">
                    ...
                    <fieldset class="mt-16 input-icon">
                        <div class="box-view-hide">
                            ...
                            <input type="password" name="password_confirmation" placeholder="Confirm your password" class="form-control password-field2" required>
                ...
                <button class="mt-40 tf-btn primary">Sign Up</button>
            </form>
            <p class="mt-35 text-center body-2 text-dark-4">Already have an account? <a href="{{ route('customer.login') }}" class="text-primary button-1">Sign In</a></p>
        </div>
