...
@section('title', 'Edit Management Payment - Admin')
...
@section('content')
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.master.payment-settings.update', $setting) }}" method="POST">
                @csrf
                @method('PUT')
                @include('admin.master_payment_setting._form', ['setting' => $setting])
