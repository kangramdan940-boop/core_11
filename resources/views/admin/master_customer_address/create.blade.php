...
@section('title', 'Tambah Alamat Customer - Admin')
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col-md-4">
                    <div id="selectedUserInfo" class="form-text"></div>
                </div>
            </div>
            ...
            <form action="{{ route('admin.master.customer-addresses.store') }}" method="POST" class="row g-3">
                @csrf
                <input type="hidden" name="sys_user_id" id="sysUserId" value="">

                <div class="col-md-6">
                    <label class="form-label">Nama Penerima</label>
                    <input type="text" name="name" id="fieldName" class="form-control" required maxlength="150">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="lines_text" id="fieldLines" class="form-control" rows="2" required></textarea>
                ...
                <div class="col-md-6 position-relative" id="shipping-section">
                    ...
                    <div class="d-flex gap-2">
                        <div class="position-relative w-100">
                            <input type="text" id="shipping_city_input" class="form-control" placeholder="Masukan Kota Tujuan (min. 4 huruf)" autocomplete="off">
                    ...
                    <input type="hidden" name="city" id="fieldCity" value="">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Tag</label>
                    <input type="text" name="tag" id="fieldTag" class="form-control" maxlength="50" value="Utama">
                </div>
