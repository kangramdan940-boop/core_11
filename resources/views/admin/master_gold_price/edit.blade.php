...
@section('title', 'Edit Harga Emas - Admin')
@section('sub-title', 'Harga Emas')
@section('breadcrumbExtra', 'Edit Harga Emas')
...
@section('content')
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.master.gold-prices.update', $price) }}" method="POST">
                @csrf
                @method('PUT')

                @include('admin.master_gold_price._form', ['price' => $price])
