...
@section('title', 'Buat Akad Murabahah - Admin')
...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Buat Akad Murabahah</h5>
            <a href="{{ route('admin.trans.cicilan-akad.index') }}" class="btn btn-light"><i class="ri-arrow-left-line"></i> Kembali</a>
        </div>
        <div class="card-body">
            <form action="{{ !empty($detailed) ? route('admin.trans.cicilan-akad.store') : route('admin.trans.cicilan-akad.store-simple') }}" method="POST" enctype="multipart/form-data">
                @csrf
